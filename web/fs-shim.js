// Браузерный шим для `node:fs`, нужный только чтобы core/calendar/calendar.js
// работал в браузере без изменений. Данные календаря загружаются страницей заранее
