    ...
    root.appendChild(
      el(
        ...
        'Сроки, которые считаются независимо от цепочки обжалования и от категории ' +
          ...
          'вычисляется от даты получения копии приказа должником. Признание и ' +
          'исполнение решений иностранных судов (глава 45 ГПК) — два отдельных срока: ' +
          'предъявление решения к принудительному исполнению — три года со дня ' +
          'вступления решения в законную силу (ч. 3 ст. 409 ГПК), и возражения ' +
          'относительно признания решения, не требующего принудительного исполнения, — ' +
          'один месяц со дня, когда заинтересованное лицо о решении узнало ' +
          '(ч. 2 ст. 413 ГПК); второй срок распространяется также на решения ' +
          'иностранных третейских судов (арбитражей) — ст. 416 ГПК. Сроки самого ' +
          'третейского разбирательства — в ситуации «Третейский суд». Заполните нужную ' +
          'дату.',
      ),
    );
  }
