    ...
    root.appendChild(
      el(
        ...
        'Сроки, которые считаются независимо от цепочки обжалования и от категории ' +
          ...
          'ГПК, касается и решений иностранных третейских судов/арбитражей) — два ' +
          'отдельных срока: предъявление решения к принудительному исполнению — три года ' +
          'со дня вступления решения в законную силу (ч. 3 ст. 409 ГПК), и возражения ' +
          'относительно признания решения, не требующего принудительного исполнения, — ' +
          'один месяц со дня, когда заинтересованное лицо о решении узнало (ч. 2 ст. 413 ' +
          'ГПК). Заполните нужную дату.',
      ),
    );
  }
