...
//
// Оба узла касаются не только решений государственных иностранных судов, но и
// решений иностранных третейских судов (арбитражей) — но по РАЗНЫМ основаниям:
//   узел 1 (ст. 409) — прямо по определению самой статьи: абз. 2 ч. 1 ст. 409
//     ГПК РФ относит «решения иностранных третейских судов (арбитражей)» к
//     понятию «решения иностранных судов» для целей главы 45, поэтому ч. 3
//     той же статьи (трёхлетний срок) распространяется на них без
//     дополнительной отсылки;
//   узел 2 (ст. 413) — через ст. 416 ГПК РФ: она распространяет правила
//     ст. 411–413 (кроме ч. 2 ст. 411 и п. 1–4, 6 ч. 1 ст. 412) на решения
//     иностранных третейских судов (арбитражей), а ст. 413 в этот диапазон
//     входит. Ст. 416 НЕ упоминает ст. 409–410 — на узел 1 она не
//     распространяется и не нужна: у него своё основание (см. выше).
...
export const FOREIGN_JUDGMENT_ENFORCEMENT_PRESENTATION = {
  ...
  logic:
    ...
    'восстановление прямо предусмотрено самой нормой. Распространяется также ' +
    'на решения иностранных третейских судов (арбитражей) — абз. 2 ч. 1 ' +
    'ст. 409 ГПК РФ относит их к «решениям иностранных судов» для целей ' +
    'главы 45.',
  midnight_rule: 'ч. 3 ст. 108 ГПК РФ',
  restoration_norm: 'ст. 112 ГПК РФ',
  norm_versions: [
