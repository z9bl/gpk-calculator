...
// (отмена постановления третейского суда о компетенции, ч. 2 ст. 422.1)
// сознательно НЕ включены в список — годичный потолок ч. 7 ст. 112 к ним не
// применяется. Основания:
...
//    обжалования/подачи. Оба узла остаются вне этого списка, годичный
//    потолок восстановления к ним не подключается.
//
