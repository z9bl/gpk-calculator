...
//
// В `fields` перечислены только поля дат: они рисуются общим механизмом
// (renderInviteField) и по тесту принадлежат ровно одной ситуации. Списка
// перерывов срока (`enforcement_interruptions`, ст. 22 ФЗ № 229-ФЗ) здесь нет
// намеренно: это не дата, а повторяемый список, и один и тот же список нужен
