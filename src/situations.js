...
export const SITUATIONS = [
  ...
  },
  {
    ...
    // Сроки третейского разбирательства из этого пула выделены в свою ситуацию
    // «Третейский суд» (см. ниже): узлов набралось четыре, и на экране пула они
    // тонули среди сроков, к третейскому суду отношения не имеющих. Перенос
    // был перегруппировкой, а не правкой расчёта: нормы, якоря и поля узлов не
    // изменились.
    ...
    // у них нет отдельного поля *_restoration_circumstance_date. Узлы остались
    // здесь, а не уехали в «Третейский суд», хотя срок возражений (ч. 2
    // ст. 413) ст. 416 ГПК распространяет и на решения иностранных третейских
    // судов: это глава 45, срок один на решения любого иностранного суда, и
