 ...
 *     это совпадает с числом самого события (пример п. 12 ПП ВС РФ от 22.06.2021 № 17:
...
export function computeDeadline(term, anchorDate) {
  ...
  if (duration.unit === 'working_day' || duration.unit === 'day') {
    ...
    // календарный модуль, п. 16 ПП ВС РФ от 22.06.2021 № 16, п. 22 ПП ВС РФ от 22.06.2021 № 17).
    //
